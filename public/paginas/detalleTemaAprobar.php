    ...
    <div class="container" align="center" style="margin-top:50px">
      <div class="card">
        ...
        <div class="card-footer">
          <button type="button" class="btn btn-danger" onclick="location.href='aprobarTemas.php'">CANCELAR</button>
          <a href="../../app/control/aprobarTema.php?tema=<?php echo $tema ?>" class="btn btn-success">APROBAR</a>
        </div>
      </div>
    </div>
    <?php } ?>
